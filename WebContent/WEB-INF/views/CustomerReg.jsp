...
<body>
	...
	<form:form action="insertcust" method="POST" modelAttribute="customer"
		name="formc" onsubmit="return ValidateEmail()">
		<table bgcolor="white">
			<tr>
				<td>Name:</td>
				<td><form:input path="custName" type="text" name="custName" />
					<form:errors path="custName" cssClass="e" /></td>
			</tr>
			<tr>
				<td>Email:</td>
			...
			<tr>
				<td>Type:</td>
				<td><form:radiobutton name="custType" path="custType"
						value="Consumer" />Consumer</td>
			</tr>
			<tr>
				<td></td>
				<td><form:radiobutton name="custType" path="custType"
						value="Seller" />Seller</td>
			</tr>
			<tr>
				<td>Address:</td>
				<td><form:textarea name="custAddr" path="custAddr"></form:textarea>
					<form:errors path="custAddr" cssClass="e" /></td>
			</tr>
			<tr>
	...
	<script>
		function ValidateEmail() {
			...
			var email = document.forms["formc"]["custEmail"].value;
